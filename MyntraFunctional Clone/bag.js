...
function displayTotalPrice(){
    ...
    font-weight: 700;">${ele.company_name}</span>
                        <span>${ele.item_name}</span>
                    </div>
                    <div class="price-item">
                        <span class="price-item-tag">Total MRP</span>
                        <span class="price-item-value">₹${ele.original_price}</span>
                    </div>
                    <div class="price-item">
                        <span class="price-item-tag">Discount on MRP</span>
                        <span class="price-item-value priceDetail-base-discount">₹ -${ele.original_price-ele.current_price}</span>
                    </div>
                    <div class="price-item">
                    ...
                    <div class="price-footer">
                        ...
                        <span class="price-item-value">₹ ${ele.current_price+99}</span>
                    </div>
                    <hr>
                </div>`;
    });
